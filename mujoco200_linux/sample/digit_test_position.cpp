...
//Joint order: 
// 1 base, 2 LHR, 3 LHY, 4, LHP, 5 LAchillesRod
// 6 LKnee, 7 LShin, 8 LTarsus, 9 LHeelSpring, 10 LToeA, 
// 11 LToeARod, 12 LToeB, 13 LToeBRod, 14 LToePitch, 15 LToeRoll, 
// // Left Arm
// 16 LSR, 17 LSP, 18 LSY, 19 LElbow, 
// // Right Leg
// 20 RHR, 21 RHY, 22, RHP, 23 RAchillesRod
// 24 RKnee, 25 RShin, 26 RTarsus, 27 RHeelSpring, 28 RToeA, 
// 29 RToeARod, 30 RToeB, 31 RToeBRod, 32 RToePitch, 33 RToeRoll, 
// // Right Arm
// 34 RSR, 35 RSP, 36 RSY, 37 RElbow, 
...
int main(int argc, const char** argv)
{
    ...
    d->qpos[30]=0*40*3.14/180; //this is in joint qposadr 
    d->qpos[1]=0.0; //this is in joint qposadr 
    d->qpos[31]=0*-20*3.14/180; //this is in joint qposadr 
    d->qpos[32]=0*-10*3.14/180; //this is in joint qposadr 
    d->qpos[33]=0*30*3.14/180; //this is in joint qposadr 
